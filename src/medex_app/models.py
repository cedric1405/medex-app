...
class Medicine(models.Model):
    ...
    # ✅ IMPORTANT : Lien vers la pharmacie propriétaire
...
# ===============================
# 6. Stock Model (SUPPRIMÉ - Remplacé par Medicine.stock_quantity)
# ===============================
# ⚠️ Ce modèle n'est plus nécessaire car Medicine gère directement le stock
